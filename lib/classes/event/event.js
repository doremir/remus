...
export default class Event extends Item {
  ...
  toJSON() {
    ...
    if (obj.syllables) obj.syllables = misc.toStandardArray(obj.syllables.map(x => x.asText()));
    if (obj.visible === true) delete obj.visible;
    if (_.isEmpty(obj.score)) delete obj.score;
